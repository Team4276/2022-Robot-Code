...
public class TCS34725_I2C {
	...
	public TCS34725_I2C(I2C i2c, int integrationTime, int gain) {
		this.i2c = i2c;
	...
	/**
	 * Constructs the TCS34725 RGB color sensor over specified I2C port with a
	 * specified
	 * integration time and gain.
	 * 
	 * @param port            The I2C port the sensor is attached to
	 * @param integrationTime Set the about of time to sense per sample. Integration
	 *                        Time = 2.4 ms × (256 − integrationTime).
	 *                        TCS34725_INTEGRATIONTIME constants available for
	 *                        convenience.
	 * @param gain            Two bit value defining gain from 1X-60X. See
	 *                        TCS34725_GAIN constants.
	 * @param verbose         If true, spew helpful messages to console. If omitted,
	 *                        assume false.
	 */
	...
	/**
	 * Constructs the TCS34725 RGB color sensor over an already instantiated I2C
	 * object.
	 * 
